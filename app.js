// document.getElementById("main").innerText = "shashi raj";
var e = document.querySelector(".slct");
...
function renderSeats(data) {
     ...
     document.querySelector(".slct").classList.remove('v-none');
...
function saveSelectedSeat(seat) {
     ...
     if (!seat.classList.contains("select-seat")) {
          // alert(seatsSelected.length+" "+value);
